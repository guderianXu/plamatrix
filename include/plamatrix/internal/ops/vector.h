...
struct PackedVector3
{
    ...
    explicit constexpr PackedVector3(const std::array<Scalar, 3>& values)
...
template <typename Scalar>
constexpr PackedVector3<Scalar> operator+(const PackedVector3<Scalar>& lhs, const PackedVector3<Scalar>& rhs)
{
...
template <typename Scalar>
constexpr PackedVector3<Scalar> operator*(const PackedVector3<Scalar>& value, Scalar scale)
{
...
/// @return Scaled vector.
template <typename Scalar>
constexpr PackedVector3<Scalar> operator*(Scalar scale, const PackedVector3<Scalar>& value)
{
    return value * scale;
}
...
template <typename Scalar>
constexpr PackedVector3<Scalar> operator/(const PackedVector3<Scalar>& value, Scalar divisor)
{
...
template <typename Scalar>
constexpr PackedVector3<Scalar>& operator+=(PackedVector3<Scalar>& lhs, const PackedVector3<Scalar>& rhs)
{
    lhs.x += rhs.x;
    lhs.y += rhs.y;
    lhs.z += rhs.z;
...
template <typename Scalar>
constexpr Scalar dot(const PackedVector3<Scalar>& lhs, const PackedVector3<Scalar>& rhs)
{
    return lhs.x * rhs.x + lhs.y * rhs.y + lhs.z * rhs.z;
}
...
template <typename Scalar>
constexpr PackedVector3<Scalar> cross(const PackedVector3<Scalar>& lhs, const PackedVector3<Scalar>& rhs)
{
    return {
...
template <typename Scalar>
constexpr Scalar squaredNorm(const PackedVector3<Scalar>& value)
{
...
template <typename Scalar>
Scalar norm(const PackedVector3<Scalar>& value)
{
    using std::sqrt;
...
template <typename Scalar>
PackedVector3<Scalar> normalized(
    const PackedVector3<Scalar>& value,
...
template <typename Scalar>
bool isFinite(const PackedVector3<Scalar>& value)
{
    using std::isfinite;
