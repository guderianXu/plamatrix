...
namespace plamatrix::internal::block_schur_detail
{
    ...
    void copyLastCudaSchurValuesToDevice(Scalar*, std::size_t, SchurComplementSolverWorkspace<Scalar>&)
    {
        throw std::runtime_error("CUDA Schur handoff requires PLAMATRIX_WITH_CUDA=ON");
    }
    template <typename Scalar>
    std::vector<Scalar> assembleSchurValuesOnCuda(Index,
                                                  Index,
                                                  ...
                                                  const std::vector<Index>&,
                                                  const std::vector<Index>&,
                                                  SchurComplementSolverWorkspace<Scalar>&,
                                                  bool)
    {
    ...
    template <typename Scalar>
    std::vector<Scalar> assembleSchurValuesOnOpenCl(Index,
                                                    Index,
                                                    const std::vector<Scalar>&,
                                                    const std::vector<Scalar>&,
                                                    const std::vector<Scalar>&,
    ...
    template std::vector<float> assembleSchurValuesOnOpenCl(Index,
                                                            Index,
                                                            const std::vector<float>&,
                                                            const std::vector<float>&,
                                                            const std::vector<float>&,
                                                            ...
                                                            SchurComplementSolverWorkspace<float>&,
                                                            bool);
    template std::vector<double> assembleSchurValuesOnOpenCl(Index,
                                                             Index,
                                                             const std::vector<double>&,
                                                             const std::vector<double>&,
                                                             const std::vector<double>&,
